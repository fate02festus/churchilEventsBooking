				...
				<form id = "form_admin" method = "POST" enctype = "multi-part/form-data" >
					...
					<div class = "panel-body">
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "number" min="1" value = "<?php echo $fetch['phone']?>" name = "phone" required = "required" pattern="[0-9]{9,12}" title="Enter numerics value of length between 9 and 12 characters">
						</div>
						<div class = "form-group">
							<label for = "lastname">ID No: </label>
							<input class = "form-control" type = "number" name = "idno" >
						</div>
						<div class = "form-group">
						...
						<div class = "form-group">	
							...
							<input class = "form-control" name = "password" mainlength = "3" type = "password" required = "required">
						</div>
